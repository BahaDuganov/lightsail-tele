<?php
namespace Redgiant\Goodwin\Model\Import;
...
class Cms
{
    ...
    public function __construct(
        ...
        $this->_importPath = BP . '/app/code/Redgiant/Goodwin/etc/import/';
        $this->_parser = new \Magento\Framework\Xml\Parser();
    }

    public function importCms($type, $demo_version, $overwrite)
    {
        ...
        try {
            ...
            // if($this->_scopeConfig->getValue("goodwin_settings/install/overwrite_".$type)) {
            //     $overwrite = 1;
            // }
