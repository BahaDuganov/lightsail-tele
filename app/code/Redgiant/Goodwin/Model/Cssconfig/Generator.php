<?php
namespace Redgiant\Goodwin\Model\Cssconfig;
...
class Generator
{
    ...
    public function __construct(
        \Redgiant\Goodwin\Helper\Cssconfig $cssconfigData,
    ...
    protected function generateStoreCss($type, $storeId) {
        ...
        $str4 = 'goodwin/css/'.$type.'.phtml';
        $this->_coreRegistry->register('cssgen_store', $storeCode);

        try {
            $block = $this->_layoutManager->createBlock('Redgiant\Goodwin\Block\Template')->setData('area','frontend')->setTemplate($str4)->toHtml();
