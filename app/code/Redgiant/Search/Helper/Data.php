...
use Redgiant\Search\Model\Product\Url;
...
{
    const CONFIG_MODULE_PATH = 'rgsearch';
    ...
    public function getConfigGeneral($code = '', $storeId = null)
    {
        ...
        return $this->scopeConfig->getValue(
            static::CONFIG_MODULE_PATH . '/general' . $code,
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }

    /**
     * @return \Redgiant\Search\Helper\Media
     */
    ...
    public function createJsonFileForStore($store, $group)
    {
        ...
        $this->getMediaHelper()->createJsFile(
            ...
            'var redgiantSearchProducts = ' . self::jsonEncode($productList)
        );
