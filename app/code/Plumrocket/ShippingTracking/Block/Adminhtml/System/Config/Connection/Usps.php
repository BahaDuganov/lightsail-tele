...
class Usps extends \Plumrocket\ShippingTracking\Block\Adminhtml\System\Config\Connection\AbstractButton
{
    /**
    ...
    {
        return parent::render($element) . $this->_getAdditionalInfoHtml();
    }
