...
class Serial extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    protected function _renderValue(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $product = $this->baseProduct->load($handle);
        ...
        if ($this->isMarketplace($handle)) {
          $html .= base64_decode('');
        } else {
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        if ($this->isMarketplace($handle)) {
          $commentText = __('You can find Marketplace Order ID and Email in your Magento Marketplace Account. If you have any questions, please contact us at <a href="mailto:support@plumrocket.com">support@plumrocket.com</a>');
        } else {
          $commentText = __('You can find Marketplace Order ID and Email in your Magento Marketplace Account. For manual <a target="_blank" href="%1">click here</a>.', 'http://wiki.plumrocket.com/License_Installation_For_Magento_2_Marketplace_Customers');
        }
